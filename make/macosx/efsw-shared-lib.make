...
ifeq ($(config),debug)
  OBJDIR     = ../../obj/macosx/debug/efsw-shared-lib
  TARGETDIR  = ../../lib
  TARGET     = $(TARGETDIR)/libefsw-debug.dylib
  ...
  LIBS      += -lpthread -framework CoreFoundation -framework CoreServices
...
ifeq ($(config),release)
  OBJDIR     = ../../obj/macosx/release/efsw-shared-lib
  TARGETDIR  = ../../lib
  TARGET     = $(TARGETDIR)/libefsw.dylib
...
ifeq ($(config),relwithdbginfo)
  OBJDIR     = ../../obj/macosx/relwithdbginfo/efsw-shared-lib
  TARGETDIR  = ../../lib
  TARGET     = $(TARGETDIR)/libefsw.dylib
  DEFINES   += -DEFSW_DYNAMIC -DEFSW_EXPORTS -DNDEBUG
  INCLUDES  += -I../../include -I../../src
